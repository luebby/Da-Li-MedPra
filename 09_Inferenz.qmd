...
::: {.aside}
Quelle: <https://de.wikipedia.org/wiki/Prävalenzfehler> durch auf Basis von <https://twitter.com/MarcRummy/status/1464178903224889345>.
:::
...
- Wir haben gesehen, das $\color{blue}{8}$ von $170$ Covid-Fällen aus der [Impfgruppe]{.blue} kamen.
...
Wenn die Studie wiederholt werden würde. Muss dann das selbe Ergebnis, also $\color{orange}{p}=\frac{\color{blue}{8}}{170}$ herauskommen?
